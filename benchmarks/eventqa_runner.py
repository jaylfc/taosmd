...
async def retrieve_context(question: str, kg, archive, vmem) -> str:
    """Retrieve relevant context via taOSmd (mirrors beam_runner.retrieve_memories).
...
async def process_row(
    ...
    for q_idx, (question, gold_list) in enumerate(zip(questions, answers)):
        retrieved_ctx = await retrieve_context(question, kg, archive, vmem)
