...
class RemoteClient:
    ...
    async def a2a_list_members(
        ...
        **_opts,
        ...
        resp = await self._run("GET", f"/a2a/threads/{urllib.parse.quote(thread, safe='')}/members")
        return resp.get("members", [])
    ...
    async def a2a_add_member(
        ...
        **_opts,
        ...
        resp = await self._run(
            "POST", f"/a2a/threads/{urllib.parse.quote(thread, safe='')}/members", payload,
        )
        return resp
    ...
    async def a2a_remove_member(
        ...
        **_opts,
        ...
        body = {"agent": agent}
        resp = await self._run(
            "DELETE", f"/a2a/threads/{urllib.parse.quote(thread, safe='')}/members/{urllib.parse.quote(principal_id, safe='')}", body,
        )
        return resp
