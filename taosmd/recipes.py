        ...
        "properties": {
            ...
            "retrieval": {
                ...
                "properties": {
                    ...
                    "embed_model": {"type": "string", "default": "minilm-onnx",
                                    "description": "Dense ONNX embedder model dir name (e.g. minilm-onnx, arctic-embed-s). Seeds config.vector_memory.embed_model at setup; a store-level choice, not per-query"},
                },
            },
            "ingest": {
                "type": "object",
...
_register(Recipe(
    ...
    metadata={"tier": "gpu-4gb",
              ...
              "pros": ["About 2.4x faster than the 9B leader, fits a 4 GB GPU",
                       ...
                       "Dense embedder is arctic-embed-s, +0.157 R@K and +0.0565 judged over MiniLM at the same dim and latency (F-010); recipe-level tri-judge re-run pending"],
