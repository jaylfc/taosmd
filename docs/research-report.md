...
| F-014 | BEAM long-context (mem0 nugget judge, local stack): 100K 47.0% (n=100), 1M 37.5% (75/200); local-9B honestly behind mem0 frontier 64-70% at 1M, the provenanced local-tier number | [3.8](#38-beam-long-context-mem0-nugget-rubric-judge) | measured + CONFIRMED (E-013 hardened re-confirm reproduced 49.0% with abstention 100% and ZERO empty answers; F-014 stands, N-014 confined to slow-CPU gen) | benchmarks/results/beam_campaign_resume_20260616_221030.log + beam_e013_100k_20260619_110029.log |
...
| E-017 | BEAM-1M hardened re-run (n=200, N-014 empty-answer guard): does 37.5% hold once empties cannot pass? Stamps the 1M number as E-013 did the 100K | [6](#6-ongoing-work-pre-registered) | pre-registered | feat/beam-runner f7dc94e |
...
Status: E-015 RESOLVED (tau-sweep, confirms + quantifies N-015: R@K vs tau 0.50/0.60/0.70/0.78/0.85 = 0.73/0.72/0.72/0.66/0.48 against a 0.73 baseline; flat-then-cliff, no tau fires meaningfully at acceptable recall cost on answerable LoCoMo; the FTS-source half is deferred). E-016/E-017/E-018 stay pre-registered and PAUSED at 7-day usage ~94 percent to protect the hard stop; they run as budget recovers (E-017/E-018 are cheap autonomous GPU confirmations, E-016 needs a subagent harness build after a TEMPO dataset feasibility check).
