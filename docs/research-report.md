...
| E-016 | External temporal benchmark (BiTempQA did NOT verify; target TEMPO arXiv:2601.09523 or Test-of-Time, pending dataset feasibility): does the E-012 self-verify temporal lift transfer to a third-party surface? | [6](#6-ongoing-work-pre-registered) | pre-registered (feasibility-gated) | harness TBD |
