...
| E-018 | E-009 prefer_verified larger-n tri-judge confirm on a config that exhibits served-hallucination: does the no-cost benefit hold under 3 judges at larger n, to support the default flip? | [6](#6-ongoing-work-pre-registered) | pre-registered | bench/e009-claims-gate-probe |
