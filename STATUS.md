...
2. **@taOS Fedora model leaderboard** (box is FREE, pinged + @taOS taking the box): @taOS wants a full local-model tool-call leaderboard. Per the no-addresses bus rule I declined to post the Fedora endpoint and offered to RUN their harness here and return scores; awaiting their harness/prompts. Models ready: qwen3.5:9b (iq4_xs/q5_k_m/q6_k), qwen3:14b, llama3.1:8b, qwen3:4b, gemma4:12b, qwen3.6:35b-a3b-q4; qwen3.5:4b needs a pull. One Ollama job at a time on the 3060.
