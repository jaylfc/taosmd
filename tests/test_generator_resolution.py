...
def test_global_profile_overrides(at_12gb, tmp_path):
    ...
    assert gp.resolve_generator(data_dir=tmp_path) == "ollama:granite4.1:8b"
...
def test_per_agent_beats_global(at_12gb, tmp_path):
    ...
    assert gp.resolve_generator("bob", data_dir=tmp_path) == "ollama:granite4.1:8b"
...
def test_resolve_memory_model_uses_per_agent_profile(at_12gb, tmp_path):
    ...
    # per-agent profile is factual-recall (granite4.1:8b at gpu-12gb)
    ...
    assert result == "ollama:granite4.1:8b"
